   ...
   public partial class DictionaryModel : BaseModel
    {
        ...
        public void ModifyDictionaryModel(string Code, string Name, string NamePy, string SysType, int LoaDlev, string SecType, string SecName, string CategoryName, string CategoryCode, int Value, int LoadIdx, E_ValueType ValueType, string uName, string remark = "")
        {
            this.EngName = EngName;
            this.Name = Name;
            this.NamePy = NamePy;
